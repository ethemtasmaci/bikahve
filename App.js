...
import QROkuyucu from './src/QROkuyucu';
import QRGecis from './components/QRGecis';
import IsletmeMenu from './src/IsletmeMenu';
import IsletmeMenuDetay from './src/IsletmeMenuDetay'
import BiMekan from './src/BiMekan';
import BiMekanFilitre from './src/BiMekanFilitre';
import BiMekanDetay from './src/BiMekanDetay';
  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        <Drawer.Screen name="QROkuyucu" component={QROkuyucu} />
        ...
        <Drawer.Screen name="QRGecis" component={QRGecis} />
        <Drawer.Screen name="IsletmeMenu" component={IsletmeMenu} />
        <Drawer.Screen name="IsletmeMenuDetay" component={IsletmeMenuDetay} />

        <Drawer.Screen name="BiMekan" component={BiMekan} />
        <Drawer.Screen name="BiMekanFilitre" component={BiMekanFilitre} />
        <Drawer.Screen name="BiMekanDetay" component={BiMekanDetay} />
